  ...
  return (
    <>
      <details>
        ...
        <p>
          此项目是 ClazhBreak 的广泛部署. <br/>
          本项目旨在为用户提供一个 针对信息技术课堂场景设计的 用于获取 娱乐/逃避监管项目的 资源整合平台。<br/>
          本项目遵循开源精神，所有代码均遵循 AGPLv3+ 许可证发布，用户可以自由地查看、修改和分发代码。<br/>
          ClazhBreak 前身为 机房摸鱼之盾，经重构后更名为此.<br/>
          此项目将不在保证官方部署的可用性与稳定性.<br/>
        </p>
      </details>
